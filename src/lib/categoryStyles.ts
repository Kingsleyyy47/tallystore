...
const STYLE_MAP: Array<{ match: RegExp; style: CategoryStyle }> = [
  ...
  { match: /facebook/i, style: { icon: Facebook, color: 'text-blue-600', bg: 'bg-blue-50 dark:bg-blue-950/30', image: '/category-icons/facebook.jpg' } },
  ...
  { match: /discord/i, style: { icon: MessageCircle, color: 'text-indigo-500', bg: 'bg-indigo-50 dark:bg-indigo-950/30', image: '/category-icons/discord.jpg' } },
  ...
  { match: /tiktok/i, style: { icon: Music, color: 'text-fuchsia-600', bg: 'bg-fuchsia-50 dark:bg-fuchsia-950/30', image: '/category-icons/tiktok.jpg' } },
  { match: /snapchat/i, style: { icon: MessageCircle, color: 'text-yellow-500', bg: 'bg-yellow-50 dark:bg-yellow-950/30', image: '/category-icons/snapchat.jpg' } },
  ...
  { match: /reddit/i, style: { icon: MessageCircle, color: 'text-orange-600', bg: 'bg-orange-50 dark:bg-orange-950/30', image: 'https://cdn.simpleicons.org/reddit/FF4500' } },
  { match: /twitch/i, style: { icon: Tv, color: 'text-purple-600', bg: 'bg-purple-50 dark:bg-purple-950/30', image: 'https://cdn.simpleicons.org/twitch/9146FF' } },
  { match: /quora/i, style: { icon: Globe, color: 'text-red-700', bg: 'bg-red-50 dark:bg-red-950/30', image: 'https://cdn.simpleicons.org/quora/B92B27' } },
